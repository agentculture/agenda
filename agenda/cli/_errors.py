...
Every failure inside agenda raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`agenda.cli._output`,
...
# Exit-code policy. Documented in ``agenda learn`` output.
# 0      = success
