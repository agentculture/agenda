...
from agenda.cli._errors import EXIT_USER_ERROR, CliError
from agenda.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/agenda/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from agenda.cli._commands import cli as _cli_group
    from agenda.cli._commands import doctor as _doctor_cmd
    from agenda.cli._commands import explain as _explain_cmd
    from agenda.cli._commands import learn as _learn_cmd
    from agenda.cli._commands import overview as _overview_cmd
    from agenda.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="agenda",
        description="agenda — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
    ...
    #   from agenda.cli._commands import my_noun as _my_noun_group
